...
void task1(void* pdata)
{
  while (1)
    { 	
	  OSSemPend(Sem0,0,&err); //We add semaphore at the beginning at the beginning and the end, to secure critial section
...
void task2(void* pdata)
{
  while (1)
    { 
	  OSSemPend(Sem1,0,&err); //We add semaphore at the beginning at the beginning and the end, to secure critial section
